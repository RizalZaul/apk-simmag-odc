...
<div class="form-modul-container">
    <div class="form-section-modul">
        ...
        <!-- Form -->
        <form id="formUbahModul" enctype="multipart/form-data">
            ...
            <input type="hidden" id="modulId" name="id_modul" value="<?= $modul['id'] ?>">
            <input type="hidden" id="oldPath" value="<?= esc($modul['path']) ?>">
            ...
            <div class="form-group-modul">
                ...
                <input type="text" id="namaModul" name="nama_modul"
                    ...
                    value="<?= esc($modul['nama_modul']) ?>" required>
            </div>
            ...
            <div class="form-group-modul">
                ...
                <select id="kategoriModul" name="id_kat_m"
                    ...
                    <?php foreach ($kategori_list as $kat): ?>
                        <option value="<?= $kat['id'] ?>"
                            <?= $kat['id'] == $modul['id_kat_m'] ? 'selected' : '' ?>>
            ...
            <div class="form-group-modul">
                ...
                <textarea id="ketModul" name="ket_modul"
                    ...
                    maxlength="500" required><?= esc($modul['ket_modul']) ?></textarea>
            ...
            <div class="form-group-modul">
                ...
                <div class="radio-group-modul">
                    <div class="radio-option-modul">
                        <input type="radio" id="tipeLink" name="tipe" value="link"
                            <?= $modul['tipe'] === 'link' ? 'checked' : '' ?>>
                        <label for="tipeLink">
            ...
            <div class="form-group-modul conditional-field <?= $modul['tipe'] === 'link' ? 'show' : '' ?>"
                id="fieldLink">
                <label>
                ...
                <input type="url" id="modulLink" name="modul_link"
                    ...
                    value="<?= $modul['tipe'] === 'link' ? esc($modul['path']) : '' ?>">
                <div class="error-message" id="linkError"></div>
            </div>

            <!-- Modul File (Conditional) -->
            <div class="form-group-modul conditional-field <?= $modul['tipe'] === 'file' ? 'show' : '' ?>"
                id="fieldFile">
                <label>
                ...
                <?php if ($modul['tipe'] === 'file'): ?>
                    <div class="current-file-info">
                        ...
                        <div class="current-file-name"><?= esc($modul['path']) ?></div>
                        <div class="current-file-hint">
            ...
            <div class="form-actions-modul">
                <button type="button" class="btn-modul btn-kembali"
                    onclick="window.location.href='<?= base_url('dashboard/data-modul/modul/detail/' . $modul['id']) ?>'">
                    <i class="fas fa-arrow-left"></i>
                    Kembali
                </button>
                <button type="submit" class="btn-modul btn-simpan">
...
<script>
    $(document).ready(function() {
        modulUbahInit({
            update: '<?= base_url('dashboard/data-modul/modul/update') ?>',
